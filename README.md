...
- `scripts/05_final_test.py` is implemented.
- `scripts/06_plot_results.py` is implemented.
...
- It evaluates selected pruning operating points on `D_test` and writes `results/final_test_results.json`.
- It renders the pruning curve figure and writes `figures/pruning_curve.pdf`.
